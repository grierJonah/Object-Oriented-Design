...
/**
 * A class representing a fruit of the perishable food item group. This class inherits from the
 * perishable food class since it has a "is-a" relationship. A fruit "IS-A" perishable food, so
 * for that reason it inherits the traits. */
public class Fruit extends Perishable {

  /**
   * Constructs a new fruit object and initializes it given the name, current price per unit,
   ...
   */
  public Fruit(Name name, Integer currentPricePerUnit, Integer currentAvailableQuantity,
